...
from vad_rms import RMSVADAdapter  # or import SileroVADAdapter from vad_silero
        ...
        async for message in websocket:
            ...
            if vad.is_silence(audio):
                ...
                if silence_candidate_len >= SILENCE_SIZE:
                    ...
                    if current_time - last_silence_log_time >= 2:
                        logger.info("Silence detected")
                        last_silence_log_time = current_time
...
# Select VAD implementation here
vad: VADAdapter = RMSVADAdapter(SILENCE_THRESHOLD)
# vad: VADAdapter = SileroVADAdapter()  # Uncomment to use Silero
